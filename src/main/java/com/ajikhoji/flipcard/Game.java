...
public class Game extends Application {
    ...
    private void getPlayerNames() {
        ...
        this.txtPlayerName2.setLayoutX(680.0D);
        ...
        rectStart.setOnMousePressed(eh->{
            ...
            this.txtPlayerName2.setWrappingWidth(300.0D);
            this.txtPlayerName2.setTextAlignment(TextAlignment.RIGHT);
    ...
    private void showGameResult() {
        if(this.intScorePlayerOne != this.intScorePlayerTwo) {
            ...
            tGameSessionPane.setOnFinished(e -> {
                ...
                txtWinner.setLayoutX(0.0D);
                txtWinner.setWrappingWidth(400.0D);
                txtWinner.setTextAlignment(TextAlignment.CENTER);
    ...
    private class ResourceLoader {
        ...
        public ResourceLoader() {
            imgBackCard = new Image(Game.class.getResource("cards/cardbackcover.png").toString(), DBL_CARD_WIDTH, DBL_CARD_HEIGHT, true, true);
            for (int i = 0; i < 9; i++) {
                this.imgCardsDiamond[i] = new Image(Game.class.getResource("cards/" + (i + 2) + "D.png").toString(), DBL_CARD_WIDTH, DBL_CARD_HEIGHT, true, true);
                this.imgCardsHeart[i] = new Image(Game.class.getResource("cards/" + (i + 2) + "H.png").toString(), DBL_CARD_WIDTH, DBL_CARD_HEIGHT, true, true);
                this.imgCardsSpade[i] = new Image(Game.class.getResource("cards/" + (i + 2) + "S.png").toString(), DBL_CARD_WIDTH, DBL_CARD_HEIGHT, true, true);
                this.imgCardsClover[i] = new Image(Game.class.getResource("cards/" + (i + 2) + "C.png").toString(), DBL_CARD_WIDTH, DBL_CARD_HEIGHT, true, true);
            }
        }
    }
